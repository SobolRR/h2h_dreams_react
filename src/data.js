...
export const data = [
  ...
  },
  {
    ...
    action:
      "Не пропускаю уроки в школе. Ухаживаю за своими вещами. Уважаю старших",
    letter: letter4,
  ...
  },
  {
    ...
    action:
      "перенес пожилой женщине тяжелую сумку, помогла маме по хозяйству, по уборке огорода",
    letter: letter7,
  ...
  },
  {
    ...
    letter: letter9,
    dream:
      "большой кукле, чтобы ее можно было кормить, ухаживать, одевать. Хочу чтобы она была моими другом",
    showLink: "show",
    showBtn: "show",
  },
  {
  ...
  },
  {
    ...
    letter: letter13,
    dream: "игрушечном тракторе с прицепом",
    showLink: "show",
    showBtn: "show",
  },
  {
